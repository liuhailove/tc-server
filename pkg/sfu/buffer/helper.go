...
// Unmarshal 解析传递的字节切片并将结果存储在调用此方法的 VP8 中
...
// IsH264KeyFrame 检测 h264 负载是否为关键帧
// 此代码取自 https://github.com/jech/galene/blob/codecs/rtpconn/rtpreader.go#L45
// 所有积分均属于 Juliusz Chroboczek @jech 和出色的 Galene SFU

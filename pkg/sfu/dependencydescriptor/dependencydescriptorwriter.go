...
func (w *DependencyDescriptorWriter) writeExtendedFields() error {
	...
	activeDecodeTargetPresentFlag := w.shouldWriteActiveDecodeTargetsBitmask()
	if err := w.writeBool(activeDecodeTargetPresentFlag); err != nil {
		return err
	}
	...
	if activeDecodeTargetPresentFlag {
